...
// The "Screen" buffer size (The camera view)
constexpr unsigned int VIEW_WIDTH = 1280; // or 640 for retro feel
...
// Custom Hash for ChunkCoord so it works in unordered_map
